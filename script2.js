document.addEventListener("DOMContentLoaded", () => {
    ...
    function createPlayerContainer(player) {
      ...
      addButton.addEventListener("click", () => {
        updatePlayerScore(player.player_id, player.score + 1);
      });
      ...
      playerContainer.appendChild(scoreButtons);
  
      return playerContainer;
    }
  
    function updatePlayerScore(playerId, newScore) {
      fetch(`https://4536-173-17-233-141.ngrok-free.app/api/updatePlayerScore/${currentTab}/${playerId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
